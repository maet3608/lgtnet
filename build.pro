# This is the ProGuard configuration file

#With obfuscation concurrent classes cause problems 
-dontobfuscate

# Specify the input jars, output jars, and library jars.
-injars  build/lib/LGTNet.jar
-outjars install/LGTNet.jar
-libraryjars lib
-libraryjars <java.home>/lib/rt.jar

# Ignore warings about unused classes
-dontwarn au.edu.imb.lgtnet.**
